    	...
    	<div class="container" >
			<div id="admin_alert_msg_login" class=" mt-3"></div>
			  ...
			  <div class="form-group ">
				...
				<input type="email" class="form-control" value="" id="admin_email_txt" placeholder="email@example.com">
			  </div>
			  <div class="form-group">
				<label for="exampleDropdownFormPassword2">Password</label>
				<input type="password" class="form-control"  value=""  id="admin_password_txt" placeholder="Password">
			  </div>
