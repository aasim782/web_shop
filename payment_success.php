  ...
  <hr>
		  ...
		  <hr>					
				...
				<?php
						...
						$sql = "update customer_ord_prds set status=1 where customer_id= '$customer_id' ";
						...
						$sql = "insert payment_success_order_tbl (order_id,delivery_id,date) values ($order_id,$order_id,'$today')";
						mysqli_query($con,$sql);
